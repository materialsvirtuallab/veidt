...
This script comes from Matt Newville's awesome package on XAS Data Interchange.
This implementation is written by Matt Newville. The details of this script and more examples are
provided in github repo with link: https://github.com/XraySpectroscopy/XAS-Data-Interchange.
